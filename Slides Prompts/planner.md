...
```json
{
  ...
  "slides": [
    ...
    },
    {
      ...
      "description": "Pergunta: A Maria decidiu estudar para o teste de Economia em vez de ir ao cinema com amigas. Qual é o custo de oportunidade da sua decisão? A) O preço do bilhete de cinema — Errado, isso é o custo monetário que ela poupou. B) As horas que passou a estudar — Errado, isso é o recurso (tempo) que usou. C) O prazer de ver o filme com as amigas (correta) — O custo de oportunidade é o valor da melhor alternativa sacrificada. D) A nota que vai tirar no teste — Errado, isso é o benefício da escolha, não o custo.",
    ...
    },
    {
      ...
      "description": "Pergunta: Se o preço da eletricidade subir muito, o que acontece à curva de OFERTA de uma padaria? A) A curva mantém-se — Errado, os custos de produção são determinantes da oferta. B) Há um movimento ao longo da curva — Errado, isso só acontece se o preço do PÃO mudar, não da eletricidade. C) A curva desloca-se para a ESQUERDA (correta) — O aumento do custo de produção reduz a vontade de produzir a cada preço. D) A curva desloca-se para a DIREITA — Errado, custos mais altos reduzem a oferta.",
      "reinforcement_slide": null
    },
    {
    ...
    },
    {
      ...
      "description": "Pergunta 1: Porque é que a curva da procura é descendente? A) Porque os produtores querem vender menos — Errado, a procura é sobre consumidores, não produtores. B) Porque os consumidores procuram alternativas quando o preço sobe (correta). C) Porque o governo controla os preços — Errado, estamos em concorrência, sem intervenção.\n\nPergunta 2: O João tem 2 horas livres. Pode estudar (benefício: boa nota) ou jogar futebol (benefício: exercício e diversão). Escolhe estudar. Qual é o custo de oportunidade? A) A boa nota — Errado, isso é o benefício, não o custo. B) As 2 horas — Errado, o tempo é o recurso. C) O exercício e diversão do futebol (correta).\n\nPergunta 3: Se o governo fixar o preço do pão ABAIXO do equilíbrio, o que acontece? A) Os padeiros produzem mais — Errado, preço baixo significa menos lucro. B) Haverá excesso de procura e escassez de pão (correta). C) Nada muda — Errado, interferir no preço sempre tem consequências.",
      "reinforcement_slide": null
    },
    {
