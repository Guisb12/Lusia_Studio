    ...
    ({ loading = false, disabled, className, children, ...props }, ref) => {
        return (
            <button
                ...
                className={cn(
                    "inline-flex w-full items-center justify-center gap-3 rounded-xl border border-brand-primary/15 bg-white",
                    "px-6 py-3 text-sm font-medium text-brand-primary",
                    "hover:bg-brand-primary/[0.03] hover:shadow-sm active:scale-[0.98]",
