...
export function LandingFinalCta() {
  return (
    <section className="bg-[#0b1a3b] px-5 py-12 text-white sm:px-8 md:py-16 lg:px-12">
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="font-instrument text-3xl leading-tight tracking-tight text-white sm:text-4xl">
          Pronto para começar?
        </h2>
        <p className="mt-4 text-base leading-relaxed text-white/60">
          Entre com um código de inscrição para se juntar a uma organização
          existente ou inicie sessão para continuar.
        </p>
