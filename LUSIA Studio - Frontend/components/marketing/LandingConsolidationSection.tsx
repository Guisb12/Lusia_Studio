...
const CpuArchitecture = ({
  ...
  return (
    ...
    >
      ...
      {/* 7. Cyan Light - REMOVED (path 7 removed) */}
      {/* 8. Rose Light */}
      ...
      {/* Logo Images at path STARTS (outer tips) - smaller size */}
      {/* Path 1 starts at (10, 20) - Kahoot top left */}
      <image href="/hero_logos/kahhot.svg" x="5" y="15" width="10" height="10" />
      {/* Path 2 starts at (180, 10) - PowerPoint top right */}
      <image href="/hero_logos/powerpoint.svg" x="175" y="5" width="10" height="10" />
      {/* Path 4 starts at (170, 80) - Excel bottom right */}
      <image href="/hero_logos/excel.svg" x="165" y="75" width="10" height="10" />
      {/* Path 5 starts at (135, 65) - Google Calendar lower right */}
      <image href="/hero_logos/google_calendar.svg" x="130" y="60" width="10" height="10" />
      {/* Path 6 starts at (94.8, 95) - bottom center */}
      <image href="/hero_logos/notebookLM.svg" x="89.8" y="90" width="10" height="10" />
      {/* Path 7 REMOVED - bottom left */}
      {/* Path 8 starts at (30, 30) - Word left side */}
      ...
      <g>
        ...
        />
        {/* LUSIA Logo and Text using special typography */}
...
// Wrapper for the landing section
export function LandingConsolidationSection() {
  return (
    <section className="bg-brand-bg px-5 py-12 sm:px-8 md:py-16 lg:px-12">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="relative mx-auto aspect-[2/1] w-full max-w-[700px]">
          <CpuArchitecture 
