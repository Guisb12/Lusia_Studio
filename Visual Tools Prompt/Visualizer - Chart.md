# Visualizer read_me — Chart module (exact raw output)

NOTE: The Core Design System, CSS Variables, UI Components, and Color Palette sections
are identical to the mockup module and are omitted here to avoid duplication.
Only the UNIQUE chart-specific content is included below.
